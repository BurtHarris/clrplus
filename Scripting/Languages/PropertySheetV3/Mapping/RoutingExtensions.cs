...
namespace ClrPlus.Scripting.Languages.PropertySheetV3.Mapping {
    ...
    public static class RoutingExtensions {
        ...
        internal static ToRoute MapToObject<TParent>(this string memberName, RouteDelegate<TParent> route, IEnumerable<ToRoute> childRoutes = null, IEnumerable<ToRoute> fallbackRoutes = null) where TParent : class {
        ...
        internal static ToRoute MapToValue<TParent>(this string memberName, ValueDelegate<TParent> route, IEnumerable<ToRoute> childRoutes = null) {
            return () => new View<TParent>(memberName, route, childRoutes);
        }
        ...
        internal static ToRoute MapToEnumerable<TParent>(this string memberName, EnumerableDelegate<TParent> route, IEnumerable<ToRoute> childRoutes = null) {
            return () => new View<TParent>(memberName, route, childRoutes);
        }
        ...
        internal static ToRoute MapToList<TParent>(this string memberName, ListDelegate<TParent> route, IEnumerable<ToRoute> childRoutes = null) {
            return () => new View<TParent>(memberName, route, childRoutes);
        }
        ...
        internal static ToRoute MapToDictionary<TParent, TKey, TVal>(this string memberName, DictionaryDelegate<TParent, TKey, TVal> route, IEnumerable<ToRoute> childRoutes = null) {
        ...
        internal static ToRoute MapToDictionary<TParent, TKey, TVal>(this string memberName, DictionaryDelegate<TParent, TKey, TVal> route, Func<string, string> keyExchanger, IEnumerable<ToRoute> childRoutes = null) {
